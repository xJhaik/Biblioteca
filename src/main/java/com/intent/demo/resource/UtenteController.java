...
public class UtenteController {
    ...
    @GetMapping(value = "/utente/{idUtente}/lista-libri")
    public ListaLibriModel getListeAssociate (@PathVariable int idUtente){
        return (ListaLibriModel)utenteRepository.findById(idUtente).get().getListaLibri();
    }
}
